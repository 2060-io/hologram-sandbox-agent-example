...
# =============================================================================
#
# This script sets up the Hologram Example Agent VS locally:
...
SERVICE_DESCRIPTION="${SERVICE_DESCRIPTION:-Example Hologram AI agent}"
SERVICE_LOGO_URL="${SERVICE_LOGO_URL:-https://hologram.zone/images/ico-hologram.png}"
...
if ! curl -sf "${ORG_VS_ADMIN_URL}/api" > /dev/null 2>&1; then
  ...
  err "Make sure the hologram-ai-agent-example-deps organization is deployed and reachable."
  exit 1
fi
